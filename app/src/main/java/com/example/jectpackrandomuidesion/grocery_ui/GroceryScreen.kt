package com.example.jectpackrandomuidesion.grocery_ui
...
fun AppBar(){
    ...
    Row (
       ...
       TextField(value = "",
        ...
        IconButton(onClick = {}) {
            Icon(imageVector = Icons.Default.FavoriteBorder, contentDescription = "", tint = Color.White)
        }
        IconButton(onClick = {  }) {
        ...
        Row (
            ...
            Row (
                ...
                Icon(painter = painterResource(id = R.drawable.ic_money),
                    contentDescription = "", tint = Color(0xFF6FCF97))
                Column(
...
fun QrButton(){
    ...
    modifier = Modifier
        ...
        Icon(painter = painterResource(id = R.drawable.ic_scan), contentDescription = "",
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp))
    }
...
fun Promotions(){
    LazyRow(
        ...
        item {
            PromotionItem(imagePinter = painterResource(id = R.drawable.promotion),
            title = "Fruit",
                subtitle = "Start @",
                header = "$1",
...
fun PromotionItem(
    ...
    shape = RoundedCornerShape(8.dp),
        ...
        Row {
            ...
            Image(painter = imagePinter, contentDescription = "",
            modifier = Modifier
                .fillMaxHeight()
                .weight(1f),
   ...
   Column(Modifier.padding(horizontal = 16.dp)) {
       ...
       Row (
           ...
           CategoryButton(
               ...
               backgroundColor = Color(0xffFEF4E))
